...
Then, we saved the accuracy values of these different models and the two chosen models separately as tables into csv files. These files are used in python to generate visualisations.
```{r}
